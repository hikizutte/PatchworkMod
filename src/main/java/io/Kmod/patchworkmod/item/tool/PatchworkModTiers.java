...
public class PatchworkModTiers {
    ...
    public static ForgeTier OBSIDIAN = new ForgeTier(3,2400, 10.0F, 4.5F, 5, PatchworkModTags.Blocks.NEEDS_OLDERITE_TOOL, ()-> Ingredient.of(PatchworkModItems.OBSIDIAN_INGOT.get()));
